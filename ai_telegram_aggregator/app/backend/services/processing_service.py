...
class ProcessingService:
    def __init__(self, db: AsyncSession) -> None:
        ...
        self.embedding_service = EmbeddingService.get_instance(self.settings.embedding_model_name, self.settings.embedding_batch_size)
    ...
    async def _encode_chunked(self, texts: list[str]) -> np.ndarray:
        ...
        for i in range(0, len(texts), chunk_size):
            ...
            chunk_vectors = await asyncio.to_thread(self.embedding_service.encode, chunk)
